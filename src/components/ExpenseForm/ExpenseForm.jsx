    ...
    <form className="entry-form" onSubmit={handleSubmit}>
      <div className="entry-form__grid">
        <div className={`form-field ${errors.title ? 'form-field--error' : ''}`}>
          ...
          <input name="title" value={form.title} onChange={handleChange} placeholder="Masalan: Oziq-ovqat" />
      ...
      <button type="submit" className="entry-form__submit entry-form__submit--expense">
        <MdAdd size={18} /> Xarajat qo'shish
      </button>
    </form>
  );
};
